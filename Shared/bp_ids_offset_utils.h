...
// NSString * __nonnull setup_ids_framework_if_needed(NSError * __nullable * __nullable);
NSString * __nullable force_dylibify_ids(NSError * __nullable * __nullable);
NSString * __nullable dylibify_ids_if_needed(NSError * __nullable * __nullable);
