...
void bp_setup_hooks() {
    ...
    nac_key_establishment_fn* nac_key_establishment_func = (nac_key_establishment_fn*) (ref_addr + bp_nac_key_establishment_func_offset);

    nac_sign_fn* nac_sign_func = (nac_sign_fn*) (ref_addr + bp_nac_sign_func_offset);
